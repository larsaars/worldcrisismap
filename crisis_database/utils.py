...
def infer_type_by_title(title):
    ...
    keywords = {
        ...
        'covid': 'epidemic', 'epidemic': 'epidemic', 'corona': 'epidemic', 'pandemic': 'epidemic', 'virus': 'epidemic', 'disease': 'epidemic', 'infection': 'epidemic', 'fever': 'epidemic', 'cholera': 'epidemic', 'ebola': 'epidemic', 'vaccinate': 'epidemic', 'vaccination': 'epidemic',
                'human right': 'human_rights', 'journalist': 'human_rights', 'protection': 'human_rights', 'homeless': 'human_rights', 'humanitarian': 'human_rights', 'discrimination': 'human_rights', 'racis': 'human_rights', 'social crisis': 'human_rights', 'antisemit': 'human_rights', 'inigenous': 'human_rights',
